...
export default function MobileBottomNav({ onLogin }: MobileBottomNavProps) {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex items-center justify-around gap-1 px-3.5 py-2 neu-card rounded-full shadow-2xl max-w-sm w-full">
        {/* Home */}
        <button
          type="button"
          ...
          className={`flex flex-col items-center justify-center w-12 py-1 rounded-full transition-all active:scale-90 cursor-pointer ${
            activeSection === 'home'
              ? 'text-[#047857] dark:text-emerald-400 font-bold'
              : 'text-slate-400 dark:text-slate-400'
          }`}
          aria-label="Home"
        >
          <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
            activeSection === 'home' ? 'neu-inset text-[#047857] dark:text-emerald-400 font-bold' : ''
          }`}>
        ...
        >
          <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
            activeSection === 'rooms' ? 'neu-inset text-[#047857] dark:text-emerald-400 font-bold' : ''
          }`}>
        ...
        >
          <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
            activeSection === 'amenities' ? 'neu-inset text-[#047857] dark:text-emerald-400 font-bold' : ''
          }`}>
        ...
        >
          <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
            activeSection === 'location' ? 'neu-inset text-[#047857] dark:text-emerald-400 font-bold' : ''
          }`}>
        ...
        <button
          type="button"
          onClick={onLogin}
          className="flex items-center gap-1.5 px-3.5 py-2 neu-btn text-[#047857] dark:text-emerald-300 rounded-full font-bold text-[11px] active:scale-95 transition-all cursor-pointer ml-1"
        >
